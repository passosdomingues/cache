...
\addbibresource{secoes/bibliografia.bib}
...
\instituicao{Universidade Federal de Alfenas}{UNIFAL-MG}
...
% "logotipos".
\logoInstituicao{logoUnifalQuadrada.png}
%
% Defina o nome da unidade de ensino e a sigla
\unidadeEnsino{Instituto de Ciências Exatas}{ICEx}
...
% de ensino.
\logoUnidadeEnsino{logoBCCQuadrada.png}
%
% Defina a Cidade
\cidade{Alfenas - MG}
% 
...
\programaPosGraduacao{Bacharelado em Ciência da Computação}
%
...
\titulo{Gestão de Projetos Aplicada a um Sistema de Gestão de Casos Sociais}
...
\orientador{Prof. Me. Elivandro Miguel Reis}
...
% se necessário.
\datadadefesa{04}{03}{2026}

% Para a versão final defina:
% Repita o nome do Orientador(a) no primeiro avaliador
\avaliadorA{Prof. Me. Elivandro Reis}{ICEx/UNIFAL-MG}
...
% O comando a seguir inclui o arquivo referencialTeorico.tex
% que contém o capítulo de Referencial Teórico. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/referencialTeorico}

% O comando a seguir inclui o arquivo principiosPMBOK.tex
% que contém o capítulo de Aplicação dos Princípios do PMBOK. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/principiosPMBOK}

% O comando a seguir inclui o arquivo dominiosDesempenho.tex
% que contém o capítulo de Aplicação dos 8 Dominios de Desempenho. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/dominiosDesempenho}

% O comando a seguir inclui o arquivo tailoring.tex
% que contém o capítulo de Tailoring do Projeto. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/tailoring}

% O comando a seguir inclui o arquivo planejamentoAgil.tex
% que contém o capítulo de Planejamento Ágil.
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/planejamentoAgil}

% O comando a seguir inclui o arquivo riscosIncertezas.tex
% que contém o capítulo de Análise de Riscos e Incertezas. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/riscosIncertezas}

% O comando a seguir inclui o arquivo consideracoesFinais.tex
% que contém o capítulo de Considerações Finais. 
% Detalhe: não precisa incluir a extensão .tex
\include{secoes/consideracoesFinais}
